 ...
 */
    ...
    public String getWindDir(String strAlt)
    {
        ...
        if (strAltWea.startsWith("  "))
        {
            ...
            {
                strRet = strAltWea.substring(0, 2);
            }
             }
        return strRet ;
    }
    ...
    /**
     * ftmWeatherReport method
     * @param strStationId
     * @param strAlt
     * @return
     */
    public String ftmWeatherReport(String strStationId, String strAlt)
    {

        String strReport = "\r\nThe Altitude Weather for " + strAlt + " feet is: "
                            + getAltitudeWeather(strAlt) + "\r\nWind Direction: " + getWindDir(strAlt) + " degrees \r\n"
                            + "Wind Speed: " +getWindSpeed(strAlt) + " knots \r\nWind Temperature: " + getWindTemp(strAlt)+ "\r\n";
        return strReport;
    }
